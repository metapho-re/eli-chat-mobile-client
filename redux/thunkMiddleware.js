...
export const createChat = (token, chatId, users) => (dispatch) => {
    ...
    return fetch(`${baseUrl}messages/newchat`, {
        ...
        .catch(error => dispatch(rejectCreateChat(error.message || 'Could not create chat')));
};
...
export const fetchMessages = (token, chats) => (dispatch) => {
    ...
    return fetch(`${baseUrl}messages`, {
        ...
        .catch(error => dispatch(rejectFetchMessages(error.message || 'Could not fetch messages')));
};
...
export const fetchUsers = (token, username) => (dispatch) => {
    ...
    return fetch(`${baseUrl}users`, {
        ...
        .catch(error => dispatch(rejectFetchUsers(error.message || 'Could not fetch users')));
};
...
export const logIn = credentials => (dispatch) => {
    ...
    return fetch(`${baseUrl}users/login`, {
        ...
        .catch(error => dispatch(rejectAuthenticate(error.message || 'Log in failed')));
};
...
export const logOut = token => (dispatch) => {
    ...
    return fetch(`${baseUrl}users/logout`, {
        ...
        .catch(error => dispatch(rejectLogOut(error.message || 'Log out failed')));
};
...
export const signUp = credentials => (dispatch) => {
    ...
    return fetch(`${baseUrl}users/signup`, {
        ...
        .catch(error => dispatch(rejectAuthenticate(error.message || 'Sign up failed')));
};
